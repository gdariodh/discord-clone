      ...
      <div className="login__card">
        <div className="login__cardHeader">
          ...
          <div className="login__img">
            <img src="https://www.pdvg.it/wp-content/uploads/2021/03/Discord.jpeg" alt="discord icon" />
          </div>
        </div>
        <div className="login__cardBody">
              <div className="login__cardBodyGoogle">
              <h4>Login with</h4>
              <img src="https://media-exp1.licdn.com/dms/image/C4D0BAQHiNSL4Or29cg/company-logo_200_200/0/1519856215226?e=2159024400&v=beta&t=r--a5-Dl4gvVE-xIkq8QyBzZ8mQ-OYwBOrixNzR95H0" alt="google icon"/>
              </div>
